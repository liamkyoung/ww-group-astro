...
const teamImg = new Proxy({"src":"/_astro/team-portrait-img.C_61pQu1.webp","width":3840,"height":2160,"format":"webp"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "C:/Users/liamk/Desktop/LKY/ww-group-astro/src/assets/images/team-portrait-img.webp";
							}
...
export { $$FullscreenHero as $, teamImg as t };

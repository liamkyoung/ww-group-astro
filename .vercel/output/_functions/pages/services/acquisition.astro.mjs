...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  ...
  imageSrc?: any;
  header?: string;
}; -->${renderComponent($$result, "Default", $$Default, {}, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "DefaultHero", $$DefaultHero, { "header": "Acquisition Service", "imageSrc": acquisitionHero, "body": [

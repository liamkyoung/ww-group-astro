...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Default", $$Default, {}, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "DefaultHero", $$DefaultHero, { "header": "Consulting Service", "imageSrc": "/src/assets/services/consulting-service-hero.webp", "body": [
...
}, "C:/Users/liamk/Desktop/LKY/ww-group-astro/src/pages/services/consulting/index.astro", void 0);

const $$file = "C:/Users/liamk/Desktop/LKY/ww-group-astro/src/pages/services/consulting/index.astro";
const $$url = "/services/consulting";

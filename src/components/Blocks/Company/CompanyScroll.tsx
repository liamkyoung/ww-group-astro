...
export const LOGOS = [
  { src: christUMCLogo.src, alt: "Christ United Methodist Church logo" },
  { src: cityStPeteLogo.src, alt: "City of St. Petersburg logo" },
  { src: clearPHLogo.src, alt: "ClearPH branding agency logo" },
  { src: datzLogo.src, alt: "Datz Restaurant Group logo" },
  { src: evergladesLogo.src, alt: "Everglades University logo" },
  {
    src: feldmansLogo.src,
    alt: "Feldman Equities commercial real estate logo",
  },
  { src: fulmerLeroyLogo.src, alt: "Fulmer Leroy Albee law firm logo" },
  { src: goodIntentionsLogo.src, alt: "Good Intentions vegan restaurant logo" },
  { src: hpCapitalLogo.src, alt: "HP Capital Group real estate logo" },
  { src: intermezzoLogo.src, alt: "Intermezzo Coffee & Cocktails logo" },
  { src: keiserLogo.src, alt: "Keiser University logo" },
  { src: kwStPeteLogo.src, alt: "Keller Williams St. Pete Real Estate logo" },
  { src: lidsLogo.src, alt: "Lids retail logo" },
  { src: paradecoLogo.src, alt: "Paradeco Coffee Roasters logo" },
  { src: pmgLogo.src, alt: "PMG real estate and development logo" },
  { src: pureGreenLogo.src, alt: "Pure Green juice bar logo" },
  { src: relatedLogo.src, alt: "Related Group real estate development logo" },
  { src: skywardLivingLogo.src, alt: "Skyward Living real estate logo" },
  { src: stPeteAthleticLogo.src, alt: "St. Pete Athletic logo" },
  { src: bankOfTampaLogo.src, alt: "The Bank of Tampa logo" },
  { src: denunzioLogo.src, alt: "The Denunzio Group logo" },
  { src: floridianLogo.src, alt: "The Floridian social club logo" },
  { src: waterviewLogo.src, alt: "Waterview Marinas logo" },
  { src: belpointeLogo.src, alt: "Belpointe real estate investment logo" },
];
